...
Microservices, Serverless, Clean Architecture, DDD, Event-Driven Architecture, TOGAF, BPMN, REST, GraphQL, gRPC, OpenAPI/Swagger, Service Layer, Repository Pattern, Observer Pattern
...
### Management, documentation, and design

Git, GitHub, GitLab, Jira, Trello, Confluence, Notion, Figma, Scrum, Kanban, Swagger/OpenAPI, technical documentation, and code review
...
Available for opportunities in software engineering, solution architecture, and full stack development.
